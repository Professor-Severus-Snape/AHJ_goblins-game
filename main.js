...
var Game = /*#__PURE__*/function () {
  function Game() {
    ...
    this.cells.forEach(function (cell) {
      return cell.addEventListener('click', _this.onCellClick.bind(_this));
    });
  ...
  return Game_createClass(Game, [{
    ...
    value: function start() {
      ...
      this.intervalId = setInterval(function () {
        ...
        if (_this2.previousScore === _this2.currentScore) {
          ...
          _this2.previousScore = _this2.currentScore;
        }
      }, 1000);
    }
  }, {
    ...
    value: function moveGoblin() {
      ...
      this.cell = document.querySelector(".cell-".concat(this.currentIndex));
    ...
    value: function stop() {
      ...
      this.goblin.remove();
      this.modal.title.textContent = "\u0412\u044B \u043D\u0430\u0431\u0440\u0430\u043B\u0438 \u043E\u0447\u043A\u043E\u0432: ".concat(this.currentScore);
    }
  }]);
}();
...
var Copyrights = /*#__PURE__*/function () {
  function Copyrights() {
    ...
    var link = document.querySelector('.copyrights__link');
